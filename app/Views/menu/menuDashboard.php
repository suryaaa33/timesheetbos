        ...
        <div class="main-container">
            ...
            <div class="container-fluid p-4 w-100">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <a href="<?= base_url('menu/create') ?>" class="btn btn-primary">+ Add Menu</a>
                </div>
                ...
                <div class="table-container table-responsive bg-white shadow-sm">
                    <table class="table align-middle mb-0 custom-table">
                        ...
                        <tbody>
                            <?php foreach ($menus as $i => $e): ?>
                                <tr>
                                    <td><?= $e['id_menu'] ?></td>
                                    <td><?= esc($e['nama_menu']) ?></td>
                                    <td>
                                        <a href="<?= base_url('menu/edit/' . $e['id_menu']) ?>" class="btn btn-light-icon"><i class="las la-edit icon-big"></i></a>
                                        <a href="#" class="btn btn-light-icon" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal"
                                            onclick="setDeleteUrl('<?= base_url('menu/delete/' . $e['id_menu']) ?>')">
