...
<head>
    ...
    <title>Form Add/Edit Menu</title>
...
<body>
    ...
    <div class="main-container">
        ...
        $formAction = $isEdit ? base_url('menu/update/' . $menu['id_menu']) : base_url('menu/store');
        ?>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <?php if ($isEdit): ?>
                    <a href="#" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal"
                        onclick="setDeleteUrl('<?= base_url('menu/delete/' . $menu['id_menu']) ?>')">Delete Menu</a>
                <?php endif ?>
            </div>
                ...
                <div class="d-flex justify-content-center">
                    <form method="post" action="<?= $formAction ?>" style="width: 100%; max-width: 500px;">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_menu" placeholder="Enter menu name"
                                value="<?= $isEdit ? esc($menu['nama_menu']) : '' ?>" required>
                        </div>
                        <div class="d-flex justify-content-center">
                            <?php if ($isEdit): ?>
                                <a href="<?= base_url('menu') ?>" class="btn-cancel">Cancel</a>
                            <?php endif ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content text-center p-5">
                    <div class="modal-body border-0">
                        <p class="fs-5 mb-4">Are you sure want to delete this menu?</p>
